...
export const nl = {
  ...
  'auth.naam': 'Je naam',
  'auth.wachtwoordEis': 'Minimaal 12 tekens. Een zin met een paar woorden werkt goed en is makkelijk te onthouden.',
  ...
  'auth.mfaUitleg': 'Vul de code van zes cijfers uit je authenticator-app in. Heb je die niet bij de hand, gebruik dan een herstelcode.',
  'auth.mfaCode': 'Code',
  ...
  'dashboard.banksaldoUitleg': 'Het saldo volgens je boekhouding. Dat kan afwijken van je bankapp als er nog transacties open staan.',
  ...
  'dashboard.btwUitleg': 'Wat je naar verwachting moet betalen of terugkrijgt over deze periode. Dit is een berekening, geen aangifte.',
  ...
  'inkoop.documentUitleg': 'Bewaar altijd het originele bewijsstuk. Dat is wettelijk verplicht en je hebt het nodig bij een controle.',
