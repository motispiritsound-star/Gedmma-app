...
export const nl = {
  ...
  // Testomgeving en feedback
  'omgeving.test': 'Testomgeving',
  'omgeving.testUitleg':
    'Dit is een proefversie om te bekijken en te beoordelen. De gegevens hierin zijn verzonnen; zet er geen echte administratie in.',
  'feedback.knop': 'Iets opgemerkt?',
  'feedback.titel': 'Wat valt je op?',
  'feedback.uitleg':
    'Schrijf op wat je opvalt, hoe klein ook. We noteren erbij op welk scherm je stond, zodat je dat niet hoeft uit te leggen.',
  'feedback.soort': 'Wat is het?',
  'feedback.soort.opmerking': 'Een opmerking',
  'feedback.soort.fout': 'Er gaat iets mis',
  'feedback.soort.wens': 'Dit zou ik graag willen',
  'feedback.soort.vraag': 'Een vraag',
  'feedback.bericht': 'Je opmerking',
  'feedback.naam': 'Je naam',
  'feedback.naamUitleg': 'Alleen als je wilt dat we je kunnen terugvragen.',
  'feedback.versturen': 'Versturen',
  'feedback.verstuurd': 'Dank je wel. Je opmerking staat genoteerd.',
  'feedback.overzicht': 'Opmerkingen',
  'feedback.leeg': 'Er zijn nog geen opmerkingen.',
  'feedback.leegUitleg': 'Zodra iemand iets opmerkt, komt het hier binnen.',
  'feedback.scherm': 'Scherm',
  'feedback.wie': 'Van wie',
  'feedback.wanneer': 'Wanneer',
  'feedback.antwoord': 'Antwoord',
  'feedback.antwoordPlaatsen': 'Antwoord noteren',
  'feedback.status.nieuw': 'Nieuw',
  'feedback.status.opgepakt': 'Opgepakt',
  'feedback.status.verwerkt': 'Verwerkt',
  'feedback.status.afgewezen': 'Niet doen',
  'feedback.aantalNieuw': 'nieuw',
  'feedback.alles': 'Alles',
  ...
  'facturen.herinnering': 'Herinnering',
  'facturen.herinneringUitleg': 'Deze factuur is {dagen} dagen te laat. Het bericht gaat naar {aan}. Pas aan wat je wilt; verstuurd wordt wat hier staat.',
  'facturen.herinneringVersturen': 'Herinnering versturen',
  'facturen.herinneringEerder': 'Eerder verstuurd —',
  'facturen.onderwerp': 'Onderwerp',
  'facturen.bericht': 'Bericht',
  ...
  'algemeen.acties': 'Acties',
  'instellingen.nieuweLink': 'Nieuwe link',
  'instellingen.uitnodigingTot': 'geldig tot',
  'instellingen.intrekkenVraag': 'Toegang intrekken voor',
  'instellingen.intrekkenUitleg': 'De persoon kan niet meer bij deze administratie. Wat hij heeft geboekt blijft staan, met zijn naam erbij in het auditspoor. Je kunt hem later opnieuw uitnodigen.',
