...
De rest van de cursus is één aankoop — **Gedmma Volledig**, eenmalig, geen
...
> `app.gedmma.learn.full`, koppelt je bankrekening, en de winkels storten wat
...
| Product-id | `app.gedmma.learn.full` | `app.gedmma.learn.full` |
| Naam voor de koper | Gedmma Volledig | Gedmma Volledig |
...
De eerste units blijven daar gewoon gratis en de pagina *Gedmma Volledig* legt
