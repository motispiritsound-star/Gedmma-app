# Textes de la fiche — français

Pour App Store Connect (France, Belgique, Suisse) et Google Play Console (fr-FR).
...
**Sous-titre (max 30)**
`L'arabe marocain pour enfants`

**Mots-clés (max 100)**
`darija,marocain,arabe,maroc,langue,enfants,apprendre,vocabulaire,écriture arabe,gratuit`

**Texte promotionnel (max 170)**
`Nouveau : l'application parle français, néerlandais, allemand et anglais — et lit chaque mot avec la voix de ton propre appareil.`

**Description (max 4000)**

```
Gedmma apprend le darija aux enfants et aux ados : l'arabe marocain que les gens parlent à la maison et dans la rue au Maroc. Pas l'arabe standard des manuels — la langue dans laquelle on appelle jeddti.
...
CE QUE TU APPRENDS
• 303 mots et phrases, de salam à la négociation au souq
• 16 unités qui montent de débutant (A0) jusqu'à A2
...
L'application contient une page qui explique comment on y apprend, ce qu'elle fait et ne fait pas, et comment aider à la maison. En classe, Gedmma tourne sur n'importe quel appareil, sans installation ni compte.
...
`Première version : 16 unités, 303 mots, l'alphabet arabe, des histoires et des jeux. En français, néerlandais, allemand et anglais.`
