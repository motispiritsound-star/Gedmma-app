# Winkelteksten — Nederlands

Voor App Store Connect (Nederland, België) en Google Play Console (nl-NL).
...
`Nieuw: de app spreekt nu Nederlands, Frans, Duits en Engels — en leest elk woord voor met de stem van je eigen toestel.`

**Beschrijving (max 4000)**

```
Gedmma leert kinderen en jongeren Darija: het Marokkaans-Arabisch dat mensen in Marokko thuis en op straat spreken. Niet het Standaardarabisch uit een schoolboek — de taal waarin je met jeddti belt.
...
WAT JE LEERT
• 303 woorden en zinnen, van salam tot afdingen op de souq
...
In de app staat een pagina met hoe er geleerd wordt, wat de app wel en niet doet, en hoe je thuis meehelpt. In de klas draait Gedmma op elk toestel zonder installatie of account.
...
`De eerste versie: 16 units, 303 woorden, het Arabische alfabet, verhalen en spelletjes. In het Nederlands, Frans, Duits en Engels.`
