...
export function inventariseer(koppelingen: Koppeling[]): Eindpunt[] {
  ...
  for (const { basis, router } of koppelingen) {
    ...
    const routerEistAanmelding = lagen.some((laag) => !laag.route && laag.handle?.name === 'eisAanmelding');
...
export const omschrijvingen: Record<string, string> = {
  ...
  'POST /api/v1/auth/register': 'Maakt een account met een eerste organisatie en administratie aan.',
  'POST /api/v1/auth/login': 'Meldt aan met e-mailadres en wachtwoord; vraagt zo nodig om de tweede stap.',
  'POST /api/v1/auth/mfa/verify':
    'Rondt het aanmelden af met een code uit de authenticator of een herstelcode.',
  'POST /api/v1/auth/mfa/setup': 'Begint het instellen van tweestapsverificatie en levert het geheim.',
  'POST /api/v1/auth/mfa/confirm': 'Bevestigt tweestapsverificatie met een code en levert de herstelcodes.',
  'POST /api/v1/auth/mfa/disable': 'Zet tweestapsverificatie uit na een wachtwoordcontrole.',
  'POST /api/v1/auth/password': 'Wijzigt het wachtwoord van de aangemelde gebruiker.',
  'POST /api/v1/auth/logout': 'Trekt de huidige sessie in.',
  'POST /api/v1/auth/invitations/accept': 'Aanvaardt een uitnodiging met de token uit het bericht.',
  'GET /api/v1/auth/me': 'Geeft de aangemelde gebruiker met zijn organisaties, administraties en rechten.',
  'GET /api/v1/auth/sessions': 'Toont de actieve sessies van de gebruiker, met de huidige gemarkeerd.',
  'DELETE /api/v1/auth/sessions': 'Meldt alle andere apparaten af; de huidige sessie blijft.',

  // --- Organisaties ---------------------------------------------------------
  'GET /api/v1/organisaties': 'Geeft de organisaties en administraties waar de gebruiker toegang toe heeft.',
  'POST /api/v1/organisaties': 'Maakt een nieuwe organisatie aan.',
  'GET /api/v1/organisaties/sjablonen': 'Geeft de beschikbare rekeningschema-sjablonen per rechtsvorm.',
  ...
  'GET /api/v1/organisaties/{organisatieId}/leden': 'Toont de leden van de organisatie met hun rol.',
  'POST /api/v1/organisaties/{organisatieId}/leden': 'Nodigt iemand uit voor een rol binnen de organisatie.',
  ...
  'GET /api/v1/administraties/{administratieId}/rekeningen': 'Geeft het rekeningschema.',
  'GET /api/v1/administraties/{administratieId}/btwcodes': 'Geeft de btw-codes met hun geldigheidsperiode.',
  'GET /api/v1/administraties/{administratieId}/dagboeken': 'Geeft de dagboeken.',
  ...
  'GET /api/v1/administraties/{administratieId}/dashboard': 'Geeft de kerncijfers voor het dashboard.',

  // --- Relaties -------------------------------------------------------------
  'GET /api/v1/administraties/{administratieId}/relaties': 'Zoekt relaties, met paginering via een cursor.',
  'POST /api/v1/administraties/{administratieId}/relaties':
    'Maakt een relatie aan; waarschuwt bij een mogelijke dubbele.',
  'GET /api/v1/administraties/{administratieId}/relaties/{id}': 'Geeft één relatie.',
  ...
  // --- Verkoop --------------------------------------------------------------
  'GET /api/v1/administraties/{administratieId}/verkoopfacturen': 'Zoekt verkoopfacturen en offertes.',
  ...
  'GET /api/v1/administraties/{administratieId}/verkoopfacturen/{id}/pdf': 'Levert de factuur als PDF.',
  ...
  // --- Documenten -----------------------------------------------------------
  'GET /api/v1/administraties/{administratieId}/documenten': 'Zoekt bonnen en bijlagen.',
  ...
  // --- Bank -----------------------------------------------------------------
  'GET /api/v1/administraties/{administratieId}/bankrekeningen': 'Geeft de bankrekeningen met hun saldo.',
  'POST /api/v1/administraties/{administratieId}/bankrekeningen': 'Voegt een bankrekening toe.',
  ...
  // --- Rapportage -----------------------------------------------------------
  'GET /api/v1/administraties/{administratieId}/rapporten/balans': 'Balans per datum.',
  ...
  // --- Projecten en uren ----------------------------------------------------
  'GET /api/v1/administraties/{administratieId}/projecten': 'Zoekt projecten, te filteren op status of klant.',
  'POST /api/v1/administraties/{administratieId}/projecten': 'Maakt een project aan met zijn facturatieafspraak.',
  'GET /api/v1/administraties/{administratieId}/projecten/{id}': 'Geeft een project met zijn activiteiten.',
  'PATCH /api/v1/administraties/{administratieId}/projecten/{id}': 'Wijzigt een project; vereist de verwachte versie.',
  'POST /api/v1/administraties/{administratieId}/projecten/{id}/activiteiten':
    'Voegt een activiteit toe aan een project, eventueel met een eigen tarief.',
  'GET /api/v1/administraties/{administratieId}/projecten-overzicht':
    'Geeft per project de geschreven, factureerbare en nog te factureren minuten tegen het budget.',
  'GET /api/v1/administraties/{administratieId}/uren':
    'Zoekt geschreven uren. Zonder het recht op alle uren blijft het bij de eigen uren.',
  'POST /api/v1/administraties/{administratieId}/uren': 'Schrijft uren op een project.',
  'GET /api/v1/administraties/{administratieId}/uren/{id}': 'Geeft een geschreven uur.',
  'PUT /api/v1/administraties/{administratieId}/uren/{id}':
    'Wijzigt een uur; een eerdere goedkeuring vervalt en een gefactureerd uur wijzigt niet meer.',
  'DELETE /api/v1/administraties/{administratieId}/uren/{id}':
    'Verwijdert een uur dat nog niet is gefactureerd.',
  'POST /api/v1/administraties/{administratieId}/uren/indienen': 'Dient uren in ter beoordeling.',
  'POST /api/v1/administraties/{administratieId}/uren/beoordelen':
    'Keurt uren goed of af; je eigen uren keur je niet zelf goed.',
  'POST /api/v1/administraties/{administratieId}/uren/factureren':
    'Maakt van goedgekeurde uren een conceptfactuur, gegroepeerd per activiteit en tarief.',

  // --- Audit ----------------------------------------------------------------
  'GET /api/v1/administraties/{administratieId}/audit': 'Geeft het auditspoor, nieuwste eerst.',
  'GET /api/v1/administraties/{administratieId}/audit/controle':
    'Controleert de hashketen van het auditspoor op onderbrekingen.',
};

const foutantwoord = {
  description: 'Fout, met een machineleesbare `code` en een uitlegbare `message` en `hint`.',
  content: {
    'application/json': {
...
export function bouwOpenApi(koppelingen: Koppeling[], versie: string): Record<string, unknown> {
          ...
          ? [
              {
                ...
                schema: { type: 'string' },
                description: 'Verplicht op aanmakende POST; herhaalt hetzelfde antwoord.',
              },
            ]
          : []),
          ...
          ? [
              {
                ...
                required: false,
                schema: { type: 'string' },
                description: 'De verwachte versie van de bron; voorkomt overschrijven.',
              },
            ]
          : []),
        {
