...
const TEKST = {
  nl: {
    ...
    '4-gratis': { kop: 'Beginnen kost niets.', sub: 'Het alfabet en hallo zeggen zijn gratis. Geen account, geen advertenties.' },
  ...
  fr: {
    ...
    '4-gratis': { kop: 'Commencer ne coûte rien.', sub: 'L’alphabet et les premières salutations sont gratuits. Sans compte, sans publicité.' },
  ...
  de: {
    ...
    '4-gratis': { kop: 'Anfangen kostet nichts.', sub: 'Das Alphabet und die ersten Begrüßungen sind gratis. Kein Konto, keine Werbung.' },
  ...
  es: {
    ...
    '4-gratis': { kop: 'Empezar no cuesta nada.', sub: 'El alfabeto y los primeros saludos son gratis. Sin cuenta, sin anuncios.' },
  ...
  it: {
    ...
    '4-gratis': { kop: 'Cominciare non costa nulla.', sub: 'L’alfabeto e i primi saluti sono gratis. Senza account, senza pubblicità.' },
  ...
  en: {
    ...
    '4-gratis': { kop: 'Starting costs nothing.', sub: 'The alphabet and the first greetings are free. No account, no adverts.' },
