...
const TEKST = {
  nl: {
    ...
    '4-gratis': { kop: 'Het alfabet is gratis.', sub: 'En hallo zeggen ook. Geen account, geen advertenties.' },
  ...
  fr: {
    ...
    '4-gratis': { kop: 'L’alphabet est gratuit.', sub: 'Et dire bonjour aussi. Sans compte, sans publicité.' },
  ...
  de: {
    ...
    '4-gratis': { kop: 'Das Alphabet ist gratis.', sub: 'Und Hallo sagen auch. Kein Konto, keine Werbung.' },
  ...
  es: {
    ...
    '4-gratis': { kop: 'El alfabeto es gratis.', sub: 'Y saludar también. Sin cuenta, sin anuncios.' },
  ...
  it: {
    ...
    '4-gratis': { kop: 'L’alfabeto è gratis.', sub: 'E salutare anche. Senza account, senza pubblicità.' },
  ...
  en: {
    ...
    '4-gratis': { kop: 'The Arabic script is free.', sub: 'And saying hello too. No account, no adverts.' },
