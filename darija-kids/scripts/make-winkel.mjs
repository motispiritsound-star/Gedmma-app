...
const TEKST = {
  sbaReeks: [
    'Voor ieder kind dat zijn oma wél verstaat, maar haar nog niet kan antwoorden.',
    '',
    'Sba is een leeuw uit het Atlasgebergte, en hij neemt je mee: door de poorten',
    'van Fes, over de markt van Marrakech, de bergen in waar het wit wordt, en naar',
    'zee bij Essaouira. Twaalf keer een plek, twaalf keer een dag.',
    '',
    'Op elke bladzijde staat Nederlands met één woord Darija erin. Dat woord is',
    'geen lesje ertussen — het is waar het verhaal om draait. Hoe je het uitspreekt',
    'staat eronder in gewone letters, dus je leest het voor zonder dat je de taal',
    'kent. En Rayan roept het twee keer na, want daar doet een kind vanzelf aan mee.',
    '',
    `Twaalf boeken van dertig bladzijden. ${PRENTEN.length * 12} woorden Darija, van salam`,
    'tot afdingen op de souq.',
    '',
    `Verkrijgbaar in ${hoeveelTalen} talen — je krijgt ze alle ${hoeveelTalen}.`,
    '',
    'Voor 2 tot 8 jaar. Pdf, om te lezen op een scherm of om te printen. Geen',
    'beveiliging, geen account. Komt er een verbeterde versie, dan krijg je die',
    'gratis.',
  ],
  sleutelsReeks: [
    'Een sleutel gaat van hand tot hand, tweeduizend jaar lang.',
    '',
    'Hij wordt gesmeed in het Romeinse Walili, rond het jaar 200, en verdwijnt aan',
    'het eind van dat boek de heuvels in met een karavaan. Hij hangt aan het tuig',
    'van een paard dat met Tariq de zeestraat oversteekt. Hij is erbij als Fatima',
    'in Fes haar hele erfenis uitgeeft aan een gebouw waarvan niemand weet waar het',
    'goed voor is. Als een jongen uit Tanger vertrekt en pas dertig jaar later',
    'terugkomt, via Mekka, India en China. Als er op één dag drie koningen sterven',
    'in dezelfde veldslag. Als de Rif zes jaar lang weigert mee te gaan.',
    '',
    'En in het vijftiende deel komt hij tevoorschijn uit een doos bij een oma in',
    'Utrecht.',
    '',
    `Vijftien boeken, verteld door vijftien kinderen van rond de elf die er zelf`,
    'bij waren.',
    '',
    'Achterin elk boek staat wat je in een kinderboek zelden vindt: "Wat hiervan is',
    'echt gebeurd." Zwart op wit, wat waar is en wat verzonnen. Dat is niet de',
    'bijlage maar het beste deel — want daar zie je hoe vreemd de echte',
    'geschiedenis vaak nog is.',
    '',
    `${hoofdstukken} hoofdstukken. ${getal(woorden)} woorden. Vanaf 9 jaar.`,
    '',
    `Verkrijgbaar in ${hoeveelTalen} talen — je krijgt ze alle ${hoeveelTalen}.`,
    '',
    'Pdf, om te lezen op een scherm of om te printen. Geen beveiliging, geen',
    'account. Komt er een verbeterde versie, dan krijg je die gratis.',
  ],
  ebook: [
