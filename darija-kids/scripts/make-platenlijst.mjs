...
const regels = [
  ...
  '   kind meteen.',
  '3. **Plak de hele opdracht**, ook de stijlregel en het personage. Dat is',
  '   saai en dat is precies waarom het werkt.',
  '4. **Kijk elke plaat na op letters.** Modellen schrijven graag iets op een',
  '   bord of een winkelpui. Eén Arabisch aandoend krabbeltje in beeld en de',
  '   plaat is in zes talen onbruikbaar.',
  '5. **Kijk of hij alle vier de dingen draagt**: fez, blauwe djellaba, tas,',
  '   rode babouches. Ontbreekt er een, opnieuw — niet "het valt wel mee".',
  '',
  '### Over de grootte',
  '',
  'Voor het **e-boek** is 1536 × 1024 ruim genoeg; dat wordt op een scherm',
  'gelezen. Voor **drukwerk** heb je 2100 × 1400 nodig en dat halen de meeste',
  'beeldmodellen niet in één keer. Begin dus bij het e-boek en bewaar het',
  'origineel van elke plaat: opschalen kan later, terugvinden niet.',
  '',
  '### Waar ze heen gaan',
  '',
  '```',
  'store/prentenboek/platen/1/1.jpg   ← deel 1, bladzijde 1',
  'store/prentenboek/platen/1/2.jpg',
  '…',
  'store/prentenboek/platen/12/12.jpg',
  '```',
  '',
  'Daarna `npm run prentenboek -- --deel 1` en de platen staan erin.',
  '',
]
