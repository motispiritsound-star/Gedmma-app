...
export const MAILS: Record<Taal, Pakket> = {
  nl: {
    ...
    bevestigBody: 'Iemand — waarschijnlijk jij — heeft dit adres opgegeven in Darija Kids. Bevestig het even, dan weten we zeker dat het van jou is. Doe je niets, dan gebeurt er ook niets: zonder bevestiging sturen we geen mail meer.',
    bevestigKnop: 'Ja, dit adres is van mij',
    bevestigStaart: 'Heb je je niet aangemeld? Gooi deze mail dan weg. Dat is genoeg.',
    welkomOnderwerp: 'Welkom bij Darija Kids',
    welkomKop: 'Shukran!',
    ...
    weekOnderwerp: (w) => toon(w, 'Een goede week', 'De week van Darija Kids', 'Alles staat nog klaar'),
    ...
    voet: 'Je krijgt deze mail omdat je je in Darija Kids hebt aangemeld.',
  },
  fr: {
    bevestigOnderwerp: 'Cette adresse est bien la vôtre ?',
    bevestigKop: 'Encore un clic',
    bevestigBody: "Quelqu'un — vous, sans doute — a donné cette adresse dans Darija Kids. Confirmez-la, pour que nous soyons sûrs qu'elle est bien à vous. Si vous ne faites rien, il ne se passe rien : sans confirmation, nous n'écrivons plus.",
    bevestigKnop: 'Oui, cette adresse est la mienne',
    bevestigStaart: "Vous ne vous êtes pas inscrit ? Jetez ce message, cela suffit.",
    welkomOnderwerp: 'Bienvenue chez Darija Kids',
    welkomKop: 'Shukran !',
    ...
    weekOnderwerp: (w) => toon(w, 'Une bonne semaine', 'La semaine de Darija Kids', 'Tout vous attend encore'),
    ...
    voet: 'Vous recevez ce message parce que vous vous êtes inscrit dans Darija Kids.',
  },
  de: {
    bevestigOnderwerp: 'Stimmt diese Adresse?',
    bevestigKop: 'Noch ein Klick',
    bevestigBody: 'Jemand — vermutlich du — hat diese Adresse in Darija Kids angegeben. Bestätige sie kurz, damit wir sicher sind, dass sie dir gehört. Tust du nichts, passiert auch nichts: ohne Bestätigung schreiben wir nicht weiter.',
    bevestigKnop: 'Ja, das ist meine Adresse',
    bevestigStaart: 'Nicht angemeldet? Dann wirf diese Mail weg. Das genügt.',
    welkomOnderwerp: 'Willkommen bei Darija Kids',
    welkomKop: 'Shukran!',
    ...
    weekOnderwerp: (w) => toon(w, 'Eine gute Woche', 'Die Woche bei Darija Kids', 'Es wartet alles noch'),
    ...
    voet: 'Du bekommst diese Mail, weil du dich in Darija Kids angemeldet hast.',
  },
  es: {
    bevestigOnderwerp: '¿Es esta tu dirección?',
    bevestigKop: 'Un clic más',
    bevestigBody: 'Alguien — seguramente tú — dio esta dirección en Darija Kids. Confírmala para que sepamos que es tuya. Si no haces nada, no pasa nada: sin confirmación no volvemos a escribir.',
    bevestigKnop: 'Sí, esta dirección es mía',
    bevestigStaart: '¿No te has apuntado? Tira este correo, con eso basta.',
    welkomOnderwerp: 'Bienvenido a Darija Kids',
    welkomKop: '¡Shukran!',
    ...
    weekOnderwerp: (w) => toon(w, 'Buena semana', 'La semana de Darija Kids', 'Todo sigue esperando'),
    ...
    voet: 'Recibes este correo porque te apuntaste en Darija Kids.',
  },
  it: {
    bevestigOnderwerp: 'È questo il tuo indirizzo?',
    bevestigKop: 'Ancora un clic',
    bevestigBody: "Qualcuno — probabilmente tu — ha dato questo indirizzo in Darija Kids. Confermalo, così siamo sicuri che sia tuo. Se non fai niente, non succede niente: senza conferma non scriviamo più.",
    bevestigKnop: 'Sì, questo indirizzo è mio',
    bevestigStaart: 'Non ti sei iscritto? Butta via questa mail, basta così.',
    welkomOnderwerp: 'Benvenuto in Darija Kids',
    welkomKop: 'Shukran!',
    ...
    weekOnderwerp: (w) => toon(w, 'Una bella settimana', 'La settimana di Darija Kids', 'È tutto ancora lì'),
    ...
    voet: 'Ricevi questa mail perché ti sei iscritto in Darija Kids.',
  },
  en: {
    bevestigOnderwerp: 'Is this address yours?',
    bevestigKop: 'One more tap',
    bevestigBody: 'Somebody — probably you — gave this address in Darija Kids. Confirm it, so we know it is really yours. Do nothing and nothing happens: without a confirmation we do not write again.',
    bevestigKnop: 'Yes, this address is mine',
    bevestigStaart: 'Did not sign up? Throw this away. That is enough.',
    welkomOnderwerp: 'Welcome to Darija Kids',
    welkomKop: 'Shukran!',
    ...
    weekOnderwerp: (w) => toon(w, 'A good week', 'The week at Darija Kids', 'It is all still waiting'),
    ...
    voet: 'You are getting this because you signed up in Darija Kids.',
  },
}
