...
**Het schrift komt eerst.** Unit 1 is het Arabische alfabet, in groepjes van
vier letters die hetzelfde skelet delen, elk met hun vorm aan het begin, het
midden en het eind van een woord. Wie daarna aan de woorden begint, leest ze in
plaats van ze te herkennen als plaatje.

**Elke les eindigt in een zin.** Losse woorden zijn een lijst; twee zinnen,
gemaakt van precies die woorden, maken er taal van.
...
## Citaten, vrij te gebruiken

> "Kinderen verstaan hun oma wel, maar antwoorden in het Nederlands. Dat gat
> wilden we dichten — met de taal die thuis écht gesproken wordt."
...
In deze map staat alles klaar:

- `screenshots/<taal>/<toestel>/` — schermafbeeldingen uit de echte app
...
uitgever in — dezelfde gegevens als in `src/content/operator.ts`.
