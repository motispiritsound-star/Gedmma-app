...
const nl = {
  ...
  leesTitel: 'Je boeken',
  leesLead: 'Gebruik de link uit je bestelmail. Die link is je sleutel — er is geen account en geen wachtwoord.',
  leesGeenSleutel: 'Er staat geen sleutel in dit adres. Open de link uit de mail die je bij je bestelling hebt gekregen; die ziet eruit als darijaforkids.eu/lezen#… met een rij tekens erachter.',
...
const fr: SiteCopy = {
  ...
  leesLead: 'Utilisez le lien du mail de commande. Ce lien est votre clé — il n’y a ni compte ni mot de passe.',
  leesGeenSleutel: 'Il n’y a pas de clé dans cette adresse. Ouvrez le lien du mail reçu avec votre commande ; il ressemble à darijaforkids.eu/lire#… suivi d’une suite de caractères.',
...
const de: SiteCopy = {
  ...
  leesLead: 'Nimm den Link aus deiner Bestellmail. Dieser Link ist dein Schlüssel — es gibt kein Konto und kein Passwort.',
  leesGeenSleutel: 'In dieser Adresse steht kein Schlüssel. Öffne den Link aus der Mail zu deiner Bestellung; er sieht aus wie darijaforkids.eu/lesen#… mit einer Zeichenfolge dahinter.',
...
const es: SiteCopy = {
  ...
  leesLead: 'Usa el enlace del correo de tu pedido. Ese enlace es tu llave: no hay cuenta ni contraseña.',
  leesGeenSleutel: 'Esta dirección no lleva llave. Abre el enlace del correo que recibiste con tu pedido; se parece a darijaforkids.eu/leer#… con una serie de caracteres detrás.',
...
const it: SiteCopy = {
  ...
  leesLead: 'Usa il link della mail dell’ordine. Quel link è la tua chiave: non c’è account né password.',
  leesGeenSleutel: 'In questo indirizzo non c’è nessuna chiave. Apri il link della mail che hai ricevuto con l’ordine; assomiglia a darijaforkids.eu/leggere#… con una sequenza di caratteri dopo.',
...
const en: SiteCopy = {
  ...
  leesLead: 'Use the link from your order email. That link is your key — there is no account and no password.',
  leesGeenSleutel: 'There is no key in this address. Open the link from the email you got with your order; it looks like darijaforkids.eu/read#… followed by a string of characters.',
