...
const nl = {
  ...
  boekKleinBody: 'Prentenboeken om voor te lezen. Elke bladzijde is Nederlands, met één woord Darija erin — en de ontdekking van dat woord is het verhaal. Sbaa is een leeuw uit de Atlas; hij neemt zes kinderen mee door Marokko. Twaalf woorden per deel, allemaal uitgesproken door een Marokkaanse stem.',
  boekKleinPunten: ['Deel 1 — Sbaa en de poorten van Fes', 'Twaalf woorden per boek, met de uitspraak erbij', 'Voorlezen kan ook zonder dat je zelf Darija kent'],
  boekGroot: '9 – 15 jaar',
...
const fr: SiteCopy = {
  ...
  boekKleinBody: 'Des albums à lire à voix haute. Chaque page est en français, avec un mot de darija dedans — et la découverte de ce mot, c’est l’histoire. Sbaa est un lion de l’Atlas ; il emmène six enfants à travers le Maroc. Douze mots par tome, tous prononcés par une voix marocaine.',
  boekKleinPunten: ['Tome 1 — Sbaa et les portes de Fès', 'Douze mots par livre, avec la prononciation', 'On peut le lire sans connaître le darija'],
  boekGroot: '9 – 15 ans',
...
const de: SiteCopy = {
  ...
  boekKleinBody: 'Bilderbücher zum Vorlesen. Jede Seite ist auf Deutsch, mit einem Wort Darija darin — und die Entdeckung dieses Wortes ist die Geschichte. Sbaa ist ein Löwe aus dem Atlas; er nimmt sechs Kinder mit durch Marokko. Zwölf Wörter pro Band, alle von einer marokkanischen Stimme gesprochen.',
  boekKleinPunten: ['Band 1 — Sbaa und die Tore von Fes', 'Zwölf Wörter pro Buch, mit der Aussprache', 'Vorlesen geht auch ohne eigenes Darija'],
...
const es: SiteCopy = {
  ...
  boekKleinBody: 'Álbumes para leer en voz alta. Cada página está en español, con una palabra en dariya dentro — y descubrir esa palabra es la historia. Sbaa es un león del Atlas; lleva a seis niños por Marruecos. Doce palabras por tomo, todas pronunciadas por una voz marroquí.',
  boekKleinPunten: ['Tomo 1 — Sbaa y las puertas de Fez', 'Doce palabras por libro, con la pronunciación', 'Se puede leer sin saber dariya'],
  boekGroot: '9 – 15 años',
...
const it: SiteCopy = {
  ...
  boekKleinBody: 'Albi illustrati da leggere ad alta voce. Ogni pagina è in italiano, con dentro una parola in darija — e scoprire quella parola è la storia. Sbaa è un leone dell’Atlante; porta sei bambini in giro per il Marocco. Dodici parole per volume, tutte pronunciate da una voce marocchina.',
  boekKleinPunten: ['Volume 1 — Sbaa e le porte di Fes', 'Dodici parole per libro, con la pronuncia', 'Si legge anche senza sapere il darija'],
  boekGroot: '9 – 15 anni',
...
const en: SiteCopy = {
  ...
  boekKleinBody: 'Picture books to read aloud. Every page is in English, with one Darija word in it — and discovering that word is the story. Sbaa is a lion from the Atlas; he takes six children through Morocco. Twelve words per book, all spoken by a Moroccan voice.',
  boekKleinPunten: ['Book 1 — Sbaa and the gates of Fes', 'Twelve words per book, with the pronunciation', 'You can read it aloud without knowing Darija'],
