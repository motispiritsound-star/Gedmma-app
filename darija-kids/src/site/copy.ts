...
const nl = {
  ...
  afrekenStappen: [
    ...
    ['Kies je taal', 'Nederlands, Frans, Duits, Spaans, Italiaans of Engels. Je koopt het boek, niet één vertaling: je krijgt ze alle zes.'],
  ...
  afrekenWat: [
    ...
    'Alle zes de talen in dezelfde download.',
...
const fr: SiteCopy = {
  ...
  afrekenStappen: [
    ...
    ['Choisissez votre langue', 'Français, néerlandais, allemand, espagnol, italien ou anglais. Vous achetez le livre, pas une traduction : vous recevez les six.'],
  ...
  afrekenWat: [
    ...
    'Les six langues dans le même téléchargement.',
...
const de: SiteCopy = {
  ...
  afrekenStappen: [
    ...
    ['Sprache wählen', 'Deutsch, Niederländisch, Französisch, Spanisch, Italienisch oder Englisch. Sie kaufen das Buch, nicht eine Übersetzung: Sie bekommen alle sechs.'],
  ...
  afrekenWat: [
    ...
    'Alle sechs Sprachen im selben Download.',
...
const es: SiteCopy = {
  ...
  afrekenStappen: [
    ...
    ['Elige tu idioma', 'Español, neerlandés, francés, alemán, italiano o inglés. Compras el libro, no una traducción: recibes los seis.'],
  ...
  afrekenWat: [
    ...
    'Los seis idiomas en la misma descarga.',
...
const it: SiteCopy = {
  ...
  afrekenStappen: [
    ...
    ['Scegli la lingua', 'Italiano, olandese, francese, tedesco, spagnolo o inglese. Compri il libro, non una traduzione: le ricevi tutte e sei.'],
  ...
  afrekenWat: [
    ...
    'Tutte e sei le lingue nello stesso download.',
...
const en: SiteCopy = {
  ...
  afrekenStappen: [
    ...
    ['Pick your language', 'English, Dutch, French, German, Spanish or Italian. You buy the book, not one translation: you get all six.'],
  ...
  afrekenWat: [
    ...
    'All six languages in the same download.',
