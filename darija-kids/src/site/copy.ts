...
const nl = {
  ...
  afrekenStappen: [
    ...
    ['De taal', 'Sba staat in alle zes de talen klaar: Nederlands, Frans, Duits, Spaans, Italiaans en Engels. De sleutels van Marokko is nu Nederlands; de vertalingen komen er dit jaar bij, en wie de reeks al heeft gekocht krijgt ze gratis via dezelfde link.'],
...
const fr: SiteCopy = {
  ...
  afrekenStappen: [
    ...
    ['La langue', 'Sba existe dans les six langues : néerlandais, français, allemand, espagnol, italien et anglais. Les clés du Maroc est pour l’instant en néerlandais ; les traductions arrivent cette année, et ceux qui ont déjà acheté la série les recevront gratuitement via le même lien.'],
...
const de: SiteCopy = {
  ...
  afrekenStappen: [
    ...
    ['Die Sprache', 'Sba gibt es in allen sechs Sprachen: Niederländisch, Französisch, Deutsch, Spanisch, Italienisch und Englisch. Die Schlüssel Marokkos ist zurzeit auf Niederländisch; die Übersetzungen kommen dieses Jahr dazu, und wer die Reihe schon gekauft hat, bekommt sie kostenlos über denselben Link.'],
...
const es: SiteCopy = {
  ...
  afrekenStappen: [
    ...
    ['El idioma', 'Sba está en los seis idiomas: neerlandés, francés, alemán, español, italiano e inglés. Las llaves de Marruecos está por ahora en neerlandés; las traducciones llegan este año, y quien ya haya comprado la serie las recibirá gratis por el mismo enlace.'],
...
const it: SiteCopy = {
  ...
  afrekenStappen: [
    ...
    ['La lingua', 'Sba c’è in tutte e sei le lingue: olandese, francese, tedesco, spagnolo, italiano e inglese. Le chiavi del Marocco per ora è in olandese; le traduzioni arrivano quest’anno, e chi ha già comprato la serie le riceverà gratis dallo stesso link.'],
...
const en: SiteCopy = {
  ...
  afrekenStappen: [
    ...
    ['The language', 'Sba is ready in all six languages: Dutch, French, German, Spanish, Italian and English. The Keys of Morocco is in Dutch for now; translations arrive this year, and anyone who already bought the series gets them free through the same link.'],
