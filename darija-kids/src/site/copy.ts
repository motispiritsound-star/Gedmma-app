...
const nl = {
  ...
  boekDeel1: 'Deel 1',
  boekAlleVijf: 'Alle vijf',
  boekTitel: 'Leesboeken voor onderweg naar huis',
  boekLead: 'Twee reeksen, twee leeftijden, en één bedoeling: dat een kind weet waar het vandaan komt. In het Nederlands, Frans, Duits, Spaans, Italiaans en Engels.',
  boekKlein: '2 – 8 jaar',
  boekKleinTitel: 'Sbaa de Atlasleeuw',
  boekKleinBody: 'Gewone voorleesboeken. Elke bladzijde is Nederlands, met één woord Darija erin — en de ontdekking van dat woord is het verhaal. Sbaa is een leeuw uit de Atlas; hij neemt zes kinderen mee door Marokko. Je hoeft zelf geen Darija te kennen: hoe je het woord zegt, staat er gewoon bij.',
  boekKleinPunten: ['Vijf delen, twaalf woorden per boek', 'Hoe je het zegt staat erbij, in gewone letters', 'Voorlezen kan zonder dat je zelf Darija kent'],
  boekGroot: '9 – 15 jaar',
  boekGrootTitel: 'De sleutels van Marokko',
  boekGrootBody: 'Zeven verhalen over tweeduizend jaar Marokkaanse geschiedenis, elk verteld door iemand van je eigen leeftijd die erbij was. Eén bronzen sleutel gaat van hand tot hand — van een olijvenpers in Walili tot een doos bij een oma in Nederland. Verzonnen mensen, echte gebeurtenissen; achterin elk deel staat precies wat waar is.',
...
const fr: SiteCopy = {
  ...
  boekDeel1: 'Tome 1',
  boekAlleVijf: 'Les cinq',
  boekTitel: 'Des livres pour le chemin du retour',
  boekLead: 'Deux séries, deux âges, une seule idée : qu’un enfant sache d’où il vient. En français, néerlandais, allemand, espagnol, italien et anglais.',
  boekKlein: '2 – 8 ans',
  boekKleinTitel: 'Sbaa, le lion de l’Atlas',
  boekKleinBody: 'De simples livres à lire à voix haute. Chaque page est en français, avec un mot de darija dedans — et la découverte de ce mot, c’est l’histoire. Sbaa est un lion de l’Atlas ; il emmène six enfants à travers le Maroc. Pas besoin de parler darija : la prononciation est écrite à côté.',
  boekKleinPunten: ['Cinq tomes, douze mots par livre', 'La prononciation est écrite en lettres normales', 'Se lit sans connaître le darija'],
  boekGroot: '9 – 15 ans',
  boekGrootTitel: 'Les clés du Maroc',
  boekGrootBody: 'Sept récits sur deux mille ans d’histoire marocaine, racontés chaque fois par quelqu’un de ton âge qui y était. Une clé en bronze passe de main en main — d’un pressoir à olives de Walili jusqu’à une boîte chez une grand-mère en Europe. Personnages inventés, événements réels ; à la fin de chaque tome, ce qui est vrai.',
...
const de: SiteCopy = {
  ...
  boekDeel1: 'Band 1',
  boekAlleVijf: 'Alle fünf',
  boekTitel: 'Lesebücher für den Weg nach Hause',
  boekLead: 'Zwei Reihen, zwei Altersgruppen, eine Absicht: dass ein Kind weiß, wo es herkommt. Auf Deutsch, Niederländisch, Französisch, Spanisch, Italienisch und Englisch.',
  boekKlein: '2 – 8 Jahre',
  boekKleinTitel: 'Sbaa, der Atlaslöwe',
  boekKleinBody: 'Einfach Bücher zum Vorlesen. Jede Seite ist auf Deutsch, mit einem Wort Darija darin — und die Entdeckung dieses Wortes ist die Geschichte. Sbaa ist ein Löwe aus dem Atlas; er nimmt sechs Kinder mit durch Marokko. Du musst kein Darija können: wie man es sagt, steht daneben.',
  boekKleinPunten: ['Fünf Bände, zwölf Wörter pro Buch', 'Die Aussprache steht in normalen Buchstaben daneben', 'Vorlesen geht ohne eigenes Darija'],
  boekGroot: '9 – 15 Jahre',
  boekGrootTitel: 'Die Schlüssel Marokkos',
  boekGrootBody: 'Sieben Geschichten über zweitausend Jahre marokkanische Geschichte, jedes Mal erzählt von jemandem in deinem Alter, der dabei war. Ein bronzener Schlüssel geht von Hand zu Hand — von einer Olivenpresse in Walili bis zu einer Schachtel bei einer Großmutter in Europa. Erfundene Menschen, echte Ereignisse; hinten steht, was stimmt.',
...
const es: SiteCopy = {
  ...
  boekDeel1: 'Tomo 1',
  boekAlleVijf: 'Los cinco',
  boekTitel: 'Libros para el camino a casa',
  boekLead: 'Dos series, dos edades y una sola intención: que un niño sepa de dónde viene. En español, neerlandés, francés, alemán, italiano e inglés.',
  boekKlein: '2 – 8 años',
  boekKleinTitel: 'Sbaa, el león del Atlas',
  boekKleinBody: 'Libros normales para leer en voz alta. Cada página está en español, con una palabra en dariya dentro — y descubrir esa palabra es la historia. Sbaa es un león del Atlas; lleva a seis niños por Marruecos. No hace falta saber dariya: cómo se dice está escrito al lado.',
  boekKleinPunten: ['Cinco tomos, doce palabras por libro', 'La pronunciación está en letras normales', 'Se lee sin saber dariya'],
  boekGroot: '9 – 15 años',
  boekGrootTitel: 'Las llaves de Marruecos',
  boekGrootBody: 'Siete relatos sobre dos mil años de historia marroquí, contados cada vez por alguien de tu edad que estuvo allí. Una llave de bronce pasa de mano en mano — desde un molino de aceite en Walili hasta una caja en casa de una abuela en Europa. Personajes inventados, hechos reales; al final de cada tomo, lo que es verdad.',
...
const it: SiteCopy = {
  ...
  boekDeel1: 'Volume 1',
  boekAlleVijf: 'Tutti e cinque',
  boekTitel: 'Libri per la strada di casa',
  boekLead: 'Due collane, due età e una sola intenzione: che un bambino sappia da dove viene. In italiano, olandese, francese, tedesco, spagnolo e inglese.',
  boekKlein: '2 – 8 anni',
  boekKleinTitel: 'Sbaa, il leone dell’Atlante',
  boekKleinBody: 'Semplici libri da leggere ad alta voce. Ogni pagina è in italiano, con dentro una parola in darija — e scoprire quella parola è la storia. Sbaa è un leone dell’Atlante; porta sei bambini in giro per il Marocco. Non serve sapere il darija: come si dice è scritto accanto.',
  boekKleinPunten: ['Cinque volumi, dodici parole per libro', 'La pronuncia è scritta in lettere normali', 'Si legge senza sapere il darija'],
  boekGroot: '9 – 15 anni',
  boekGrootTitel: 'Le chiavi del Marocco',
  boekGrootBody: 'Sette racconti su duemila anni di storia marocchina, narrati ogni volta da qualcuno della tua età che c’era. Una chiave di bronzo passa di mano in mano — da un frantoio di Walili fino a una scatola da una nonna in Europa. Persone inventate, fatti veri; in fondo a ogni volume c’è quello che è successo davvero.',
...
const en: SiteCopy = {
  ...
  boekDeel1: 'Book 1',
  boekAlleVijf: 'All five',
  boekTitel: 'Books for the way home',
  boekLead: 'Two series, two ages, one intention: that a child knows where they come from. In English, Dutch, French, German, Spanish and Italian.',
  boekKlein: '2 – 8 years',
  boekKleinTitel: 'Sbaa the Atlas Lion',
  boekKleinBody: 'Plain books to read aloud. Every page is in English, with one Darija word in it — and discovering that word is the story. Sbaa is a lion from the Atlas; he takes six children through Morocco. You do not need to speak Darija: how to say the word is written next to it.',
  boekKleinPunten: ['Five books, twelve words each', 'The pronunciation is written in normal letters', 'Reads aloud without knowing Darija'],
  boekGroot: '9 – 15 years',
  boekGrootTitel: 'The Keys of Morocco',
  boekGrootBody: 'Seven stories across two thousand years of Moroccan history, each told by someone your own age who was there. One bronze key passes from hand to hand — from an olive press in Walili to a box at a grandmother’s house in Europe. Invented people, real events; the back of every book says exactly what is true.',
