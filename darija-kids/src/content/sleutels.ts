...
export const REEKS: Omit<Sleuteldeel, 'hoofdstukken'>[] = [
  ...
  },
  {
    ...
    echt: [
      ...
      'Haar zus Maryam stichtte in dezelfde stad de al-Andalusiyyin-moskee.',
      'Fes zelf was kort daarvoor gesticht, onder Idris I en zijn zoon Idris II.',
    ],
    verzonnen: [
      'Hind heeft niet bestaan.',
      ...
      'De scène waarin Fatima met Hind praat is verzonnen.',
    ],
  },
  {
  ...
  },
  {
    ...
    echt: [
      ...
      'Sommige delen van de Rihla zijn waarschijnlijk overgeschreven uit andere reisverslagen; daar wordt al eeuwen over gediscussieerd.',
    ],
    verzonnen: [
  ...
  },
  {
    ...
    verzonnen: [
      'De gesprekken en zijn binnenwereld zijn verzonnen. Wat hij werkelijk dacht over zijn gedwongen bekering weten we niet.',
