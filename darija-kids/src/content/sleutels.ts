...
export const REEKS: Omit<Sleuteldeel, 'hoofdstukken'>[] = [
  ...
  },
  {
    ...
    echt: [
      ...
      'Bij Tondibi in 1591 won een Marokkaans leger met vuurwapens van een veel groter Songhai-leger zonder. Ongeveer de helft van de Marokkaanse soldaten overleefde de woestijnreis niet.',
      'De geleerde Ahmad Baba werd uit Timboektoe weggevoerd naar Marrakech. Zijn bibliotheek van zestienhonderd boeken werd in beslag genomen; volgens hemzelf was dat de kleinste verzameling in zijn familie. Hij gaf jarenlang les in Marrakech en keerde later terug.',
      'De suiker kwam uit rietvelden in de Souss, verwerkt in watermolens. Het werk was grotendeels dwangarbeid en er is veel bos voor gekapt.',
      'Ahmad al-Mansur wisselde gezantschappen uit met koningin Elizabeth I van Engeland. Zijn gezant Abd el-Ouahed ben Messaoud was in 1600 in Londen; het portret dat daar van hem is geschilderd bestaat nog.',
      'Al-Mansur stierf in 1603 aan de pest. Zijn drie zonen vochten daarna jarenlang om de troon en het rijk viel uiteen.',
      'Moulay Ismail liet het paleis rond 1700 afbreken en het materiaal naar Meknès brengen. Wat er staat is wat niet de moeite van het vervoeren waard was.',
    ],
    verzonnen: [
      'Lalla, haar vader en haar kinderen hebben niet bestaan.',
      'De uitspraken van al-Mansur in dit boek zijn verzonnen, en het verhaal van de nar die zei dat het een mooie ruïne zou worden is vermoedelijk later bedacht.',
      'Dat Shakespeare het Marokkaanse gezantschap in Londen zou hebben gezien en dat Othello daaruit voortkwam, wordt al eeuwen gezegd maar is nooit bewezen. Het staat er daarom als iets wat gezegd wordt.',
    ],
  },
  {
  ...
  },
  {
    ...
    echt: [
      ...
      'Het Amerikaanse consulaat in Tanger, geschonken door de sultan, is het oudste Amerikaanse overheidsgebouw buiten de Verenigde Staten. Het is nu een museum.',
      'Het verdrag van 1786 werd onderhandeld door Thomas Barclay. Anders dan bij de andere staten aan die kust vroeg Marokko geen jaarlijkse betaling.',
      'In het verdrag staat dat de bemanning van een gestrand schip geholpen wordt en dat hun niets wordt afgenomen. Dat was toen allesbehalve vanzelfsprekend.',
      'In 1789 schreef George Washington aan de sultan. Die brief begint met "Grote en edelmoedige vriend" en bestaat nog.',
      'Kapers voeren aan beide kanten van de Middellandse Zee: uit Salé, Algiers, Tunis en Tripoli, maar ook uit Malta, Livorno en Spanje. Een kaper had papieren van een vorst waarin stond welke schepen hij mocht nemen.',
      'In de havens van de Middellandse Zee werd eeuwenlang een mengtaal gesproken — de lingua franca — van Italiaanse, Spaanse, Arabische en Portugese woorden, zonder vervoegingen.',
    ],
    verzonnen: [
      'Brahim en de havenschrijver Si Lhabib hebben niet bestaan.',
      'De inhoud van de gesprekken over het verdrag is verzonnen.',
      'De brieven van gevangengenomen bemanningen die Brahim overschrijft zijn verzonnen; dat zulke brieven bij duizenden zijn geschreven, is dat niet.',
    ],
  },
  {
