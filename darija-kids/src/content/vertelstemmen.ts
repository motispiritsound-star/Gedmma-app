 ...
 *
 * De lezer op de website noemt de stemmen van het toestel Amir, Adam en
 * Yassine (man) en Sarah en Yousra (vrouw) — zie `src/site/lezer.js`. Komen
 * er ooit opnames, dan hoort `toon` hieronder daarbij aan te sluiten in plaats
 * van een tweede rij namen op te leveren. Deze vijf zijn allemaal
 * mannenstemmen, dus dat worden er hooguit drie.
 */
