...
export const fr: Strings = {
  ...
  learn: {
    ...
    eersteKeer: "Ta toute première leçon t'attend. On commence par l'alphabet.",
    beginnen: 'Commencer',
    gaVerder: 'Continuer',
    herhalen: 'Réviser',
  ...
  lesson: {
    ...
    gezegd: 'C’est dit !',
    neemOp: 'Enregistre',
    stopOpname: 'Arrête l’enregistrement',
    neemtOp: 'J’enregistre…',
    tikEnNeemOp: 'Touche, dis le mot, touche encore.',
    hoorJezelf: 'Réécoute-toi à côté de la voix.',
    mijnOpname: 'Réécoute-toi',
    geenToestemming: 'Le micro n’est pas autorisé. Cela se règle dans les réglages de l’appareil.',
    spreekIn: 'Parler',
    ikLuister: 'J’écoute…',
  ...
  words: {
    ...
    meerOnderwerpen: 'Plus de thèmes',
    vorigeOnderwerpen: 'Thèmes précédents',
  ...
  bonus: {
    ...
    taak: {
      ...
      spreken: { naam: 'À voix haute', uitleg: 'Dis six mots à voix haute, enregistre-toi, et réécoute-toi à côté de la voix qui le dit bien.' },
    },
    nogNiet: {
      ...
      spreken: 'Cet appareil n’a pas de micro, ou tu connais encore trop peu de mots.',
    },
  ...
  settings: {
    ...
    herinnering: 'Rappel',
    herinneringHint: 'Une notification par jour, à l’heure que tu choisis ici. Rien ne sort de l’appareil : il met un réveil, c’est tout. Désactivé tant que tu ne l’actives pas.',
    herinneringTijd: 'À quelle heure',
    herinneringTitel: 'Yallah, on s’entraîne',
    herinneringBody: 'Cinq minutes de darija et ta série reste en vie.',
    ...
    geenDarija: "Aucune voix de téléphone ne parle darija : elles sont toutes entraînées sur l'arabe standard. Ce que vous entendez est donc une approximation, sauf là où l'app contient un vrai enregistrement.",
  ...
  landing: {
    ...
    faq: [
      ...
      [
        ...
        'Oui. Tout est dans l’application elle-même — les leçons, les enregistrements et les lettres. Une fois téléchargée, elle fonctionne sans internet : pratique en voiture, en avion ou au Maroc.',
      ],
      [
  ...
  unlock: {
    ...
    krijgt: (gezin) => [
      ...
      ...(gezin ? ['Pour toute la famille : jusqu’à six personnes partagent un abonnement'] : []),
    ...
    boek: {
      ...
      bevat: [
        "L'alphabet : 28 lettres avec leurs trois formes et un mot d'exemple",
        'Le parcours : les 17 unités et toutes les explications de grammaire réunies',
        'Les 304 mots par thème, avec la graphie latine',
        'Les 100 phrases du cours',
      ],
      inclusief: 'e-book inclus',
      bijJaar: "Avec l'abonnement annuel, l'e-book est compris — inutile de l'acheter à part.",
