...
const SECTIONS_NL: Section[] = [
  ['Wat we verzamelen', [
    'Van het kind: niets. Darija Kids heeft geen account, vraagt een kind nooit om een e-mailadres en stuurt niets van het oefenen naar een server.',
...
const SECTIONS_FR: Section[] = [
  ['Ce que nous collectons', [
    'De l’enfant : rien. Darija Kids n’a pas de compte, ne demande jamais son adresse e-mail à un enfant et n’envoie rien de ses exercices à un serveur.',
...
const SECTIONS_DE: Section[] = [
  ['Was wir erheben', [
    'Vom Kind: nichts. Darija Kids hat kein Konto, fragt ein Kind nie nach einer E-Mail-Adresse und schickt nichts vom Üben an einen Server.',
...
const SECTIONS_IT: Section[] = [
  ['Che cosa raccogliamo', [
    'Del bambino: niente. Darija Kids non ha un account, non chiede mai a un bambino il suo indirizzo e-mail e non manda niente degli esercizi a un server.',
...
const SECTIONS_EN: Section[] = [
  ['What we collect', [
    'From the child: nothing. Darija Kids has no account, never asks a child for an email address, and sends nothing about the practising to a server.',
...
const SECTIONS_ES: Section[] = [
  ['Qué recogemos', [
    'Del niño: nada. Darija Kids no tiene cuenta, nunca le pide a un niño su dirección de correo y no manda nada de los ejercicios a ningún servidor.',
