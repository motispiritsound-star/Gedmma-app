...
| | |
|---|---|
| ✅ Klaar | Capacitor-config, het complete Android-project, alle app-iconen en splashschermen, winkelteksten in vijf talen, een privacypagina in de app, en de in-app-aankoop inclusief ouderpoort en herstelknop |
...
Spanje Spaans, enzovoort. Wisselen kan altijd bij Instellingen, en op Android 13 en later ook
via "App-taal" in de systeeminstellingen, omdat `locales_config.xml` de vijf
talen aanmeldt.
...
- **Google Play**: voeg per taal een winkelvermelding toe (nl-NL, fr-FR, de-DE,
  es-ES, en-GB) met de teksten uit `store/`. Play toont de bezoeker automatisch de
...
- **App Store Connect**: voeg dezelfde vijf lokalisaties toe onder de
...
`store/listing.nl.md`, `.fr.md`, `.de.md`, `.es.md` en `.en.md` bevatten de naam,
