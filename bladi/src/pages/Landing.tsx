  ...
  return (
    <div>
        ...
        <div className="relative mx-auto max-w-5xl px-4 py-6">
          <nav className="flex flex-wrap items-center gap-3">
            <span className="flex items-center gap-2 font-display text-2xl font-extrabold">
              <span className="grid h-9 w-9 place-items-center rounded-xl bg-gradient-to-br from-saffron-400 to-terra-500 text-night-950">ب</span>
              {t.common.appName}
            </span>
          ...
          <div className="grid items-center gap-8 py-14 sm:py-20 md:grid-cols-2">
            <div>
              <p className="ar inline-block text-2xl font-bold text-zellige-600 dark:text-zellige-300">بلادي</p>
      ...
      <footer className="border-t border-[var(--line)] py-10 text-center text-sm text-[var(--ink-soft)]">
        <p className="font-display text-lg font-extrabold text-[var(--ink)]">{t.common.appName} · بلادي</p>
