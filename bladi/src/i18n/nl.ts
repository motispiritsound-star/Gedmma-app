...
export const nl = {
  ...
  learn: {
    ...
    geenStemUitleg:
      'Bladi leest de woorden nu voor in de Latijnse schrijfwijze met een Franse stem — herkenbaar, maar geen echt Marokkaans. Een Arabische stem installeren kan meestal via de instellingen van je apparaat, bij spraak of tekst-naar-spraak.',
    begrepen: 'Begrepen',
  },
  ...
  settings: {
    ...
    stemBenadering: (naam: string): string =>
      `Geen Arabische stem gevonden. Bladi leest de Latijnse schrijfwijze met ${naam} — dat benadert het, meer niet.`,
    ...
    oudersLink: 'Ouder of leerkracht? Lees wat Bladi wel en niet doet.',
  },
  ...
  landing: {
    ...
    citaatBody:
      'De mooiste les komt niet uit een app. Laat je kind je elke dag één woord leren — uitleggen is de beste manier om iets vast te zetten. Bladi geeft de woorden, jullie geven het gesprek.',
    ...
    faq: [
      ...
      [
        'Werkt het offline?',
        'Ja. Bladi installeert zich als app op je telefoon, tablet of laptop en werkt daarna zonder internet — handig in de auto, het vliegtuig of in Marokko zelf.',
      ],
      [
    ...
    ctaKnop: 'Start nu',
    voetnoot: '“Bladi” betekent: mijn land. De taal die erbij hoort, leer je hier.',
  },

  unlock: {
    titel: 'Bladi Volledig',
    ...
    alleenInApp: 'Kopen kan in de Bladi-app uit de App Store of Google Play. Op deze website blijven de eerste units gewoon gratis.',
    bezig: 'Bezig…',
    alOpen: 'Je hebt Bladi Volledig. Alles staat open — shukran!',
    ...
    poortKnop: 'Verder',
    slotTitel: 'Deze unit hoort bij Bladi Volledig',
    slotKnop: 'Bekijken',
  },

  welcome: {
    titel: 'Ahlan! Welkom bij Bladi',
