...
const VORMEN = {
  ...
  microfoon: { d: ['M12 3.5a2.6 2.6 0 0 1 2.6 2.6v5.4a2.6 2.6 0 0 1-5.2 0V6.1A2.6 2.6 0 0 1 12 3.5z', 'M6.2 11a5.8 5.8 0 0 0 11.6 0', 'M12 16.8v3.7', 'M9 20.5h6'] },
  stop: { gevuld: true, d: ['M7.5 7.5h9a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1h-9a1 1 0 0 1-1-1v-7a1 1 0 0 1 1-1z'] },
  afspelen: { gevuld: true, d: ['M8.5 5.9a.9.9 0 0 1 1.36-.77l8.1 5.3a.9.9 0 0 1 0 1.54l-8.1 5.3A.9.9 0 0 1 8.5 16.6z'] },
  prullenbak: { d: ['M4.5 6.8h15', 'M9.5 6.8V5.2a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v1.6', 'M6.6 6.8l.8 12a1 1 0 0 0 1 .95h7.2a1 1 0 0 0 1-.95l.8-12', 'M10.4 10.4v5.6', 'M13.6 10.4v5.6'] },
  opslaan: { d: ['M12 3.8v10.4', 'm7.6 10 4.4 4.2 4.4-4.2', 'M4.6 17.2v1.8a1.2 1.2 0 0 0 1.2 1.2h12.4a1.2 1.2 0 0 0 1.2-1.2v-1.8'] },
